...
namespace FooYes.Web.Models
{
    ...
    public class RegisterViewModel
    {
        ...
        [Required]
        [StringLength(100, ErrorMessage = "{0} must at least include {2} caracters.", MinimumLength = 6)]
        [DataType(DataType.Password)]
        [Display(Name = "Password")]
        public string Password { get; set; }
    ...
    public class ResetPasswordViewModel
    {
        ...
        [Required]
        [StringLength(100, ErrorMessage = "{0} must include at least {2} caracters.", MinimumLength = 6)]
        [DataType(DataType.Password)]
        [Display(Name = "Password")]
        public string Password { get; set; }
